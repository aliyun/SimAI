...
// Calculate the position of the first set bit in an integer.
// Parameters:
//   int val - The integer value to check.
//   int max - The maximum bit limit; the function will not check bits beyond this limit.
// Return value:
//   Returns the position of the first set bit. If no bits are set, the function returns max.
