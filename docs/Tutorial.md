...
### TOPO Templates
To enhance convenience, we provide 5 templates for common architectures, including Spectrum-X, Single Plane AlibabaHPN, Dual Plane Alibaba HPN and DCN+. The parameter `-topo` can be set.These four figures give an overview of them.
<table>
  <tr>
...
```
<img src="./images/Spectrum8gpus1psn.png" alt="Spectrum8gpus1psn" width="50%">
