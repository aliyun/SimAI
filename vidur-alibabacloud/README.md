...
| `--replica_config_pd_node_ratio` | 0.5 | Fraction of replicas allocated as prefill (P) nodes. The remaining replicas are used as decode (D) nodes. For example, 0.5 means P:D = 1:1. |
